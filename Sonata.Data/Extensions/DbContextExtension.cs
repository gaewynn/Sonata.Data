...
namespace Sonata.Data.Extensions
{
	public static class DbContextExtension
	{
		...
		public static ResultSets CallStoredProcedure(this DbContext instance, StoredProcedure storedProcedure, int? commandTimeout, IEnumerable<SqlParameter> inputParameters = null)
		{
			if (instance == null)
		...
		/// <returns>A list of lists containing result data from the stored procedure.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="instance"/> is NULL or <paramref name="storedProcedure"/> is NULL.</exception>
		public static async Task<ResultSets> CallStoredProcedureAsync(this DbContext instance, StoredProcedure storedProcedure, CancellationToken token, int? commandTimeout, IEnumerable<SqlParameter> inputParameters = null)
		{
			if (instance == null)
				throw new ArgumentNullException(nameof(instance));
			if (storedProcedure == null)
		...
		internal static ResultSets ReadFromStoredProcedure(this DbContext instance, string storedProcedureName, IEnumerable<SqlParameter> inputParameters = null, int? commandTimeout = null, params Type[] returnedTypes)
		{
			if (instance == null)
				throw new ArgumentNullException(nameof(instance));
